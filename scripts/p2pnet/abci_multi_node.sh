...
#$ -v SSH_PORT=2299
#$ -j y
#$ -e /home/aag16599bn/gcc50570/nakayama/congestion_analysis/log/
#$ -o /home/aag16599bn/gcc50570/nakayama/congestion_analysis/log/
#$ -cwd
...
PYTHON_COMMAND="python p2pnet/main.py p2p out_dir=$OUT_DIR \
