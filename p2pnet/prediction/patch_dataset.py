...
class PatchDataset(Dataset):
    ...
    def __init__(self, img_dir, img_size=(4320, 7680), separate_size=(1152, 1280), 
        ...
        self.trans_data = (None if (height == new_height and width == new_width) 
    ...
    def _padding_img(self, img):
        ...
        padded_img = np.zeros((self.padded_size[0], self.padded_size[1], 3), 
                             dtype=img.dtype)
...
def create_patch_dataloader(cfg, img_dir, **dataset_kwargs):
    """データローダーの作成"""
