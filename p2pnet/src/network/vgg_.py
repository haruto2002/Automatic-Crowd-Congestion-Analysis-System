...
model_paths = {
    "vgg16": "./src/network/vgg16_features-amdegroot-88682ab5.pth",
    "vgg16_bn": "./src/network/vgg16_bn-6c64b313.pth",
}


def get_pretrained_weight():
    if not os.path.exists(model_paths["vgg16"]):
        subprocess.run(
            [
                "wget",
